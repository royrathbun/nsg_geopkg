...
_NSG Req 12: A GeoPackage SHALL contain one complete NMIS metadata XML instance document that describes the entire GeoPackage in a gpkg_metadata table row with the contents shown in_

_Table_ 20 _below._ [[_Ref396904608]]
...
NSG Req 13: The gpkg_metadata table row with the values shown in

Table 20 above SHALL be associated with the complete GeoPackage by a gpkg_metadata_reference table row with the contents shown in Table 21 below.

[[_Ref396906174]]Table 21: gpkg_metadata_reference Table Contents - Entire GeoPackage
...
[[_Ref396910961]]Table 23: gpkg_metadata Table Contents - Partial GeoPackage
...
_*NSG Req 15: Any gpkg_metadata table row with the values shown in*_ _*Table 23 SHALL be associated with a GeoPackage user data table, and MAY be associated with a particular row and/or column in that table by a gpkg_metadata_reference table row with the contents shown in*_ _*Table 24 below. Metadata in gpkg_metadata table row that applies to multiple GeoPackage table, row and/or column content items SHALL be associated with those items by more than one gpkg_metadata_reference table row with the contents shown in*_ _*Table 24.*_

[[_Ref396911551]]Table 24: gpkg_metadata_reference Table Contents - Partial GeoPackage
...
[[_Ref396912147]]Table 25: GeoPackage and NMIS metadata scopes
...
*_NSG Req 17: Data products contained in a GeoPackage SHALL be identified using component elements of:

* /nas:MD_Metadata/gmd:identificationInfo/nas:MD_DataIdentification/gmd:citation
* /nas:MD_Metadata/gmd:identificationInfo/nas:MD_DataIdentification/gmd:abstract
* /nas:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:lineage_*
